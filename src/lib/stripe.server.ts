// Shared Stripe access. All Stripe API calls in this project go through the
// Lovable connector gateway — the *_API_KEY values are gateway connection
// identifiers, not raw Stripe secret keys, and are server-only.
 ...
 * Throws on a missing, malformed, stale or forged signature.
 */
