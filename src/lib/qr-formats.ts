...
export const FORMATS: BusinessFormat[] = [
  ...
  {
    id: "sticker-circle-80",
    name: "Circular sticker 80 mm",
    category: "sticker",
    shape: "circular",
    medium: "print",
    width: 80,
  ...
  {
    id: "sticker-circle-100",
    name: "Circular sticker 100 mm",
    category: "sticker",
    shape: "circular",
    medium: "print",
    width: 100,
  ...
  {
    id: "sticker-sq-100",
    name: "Square sticker 100 × 100 mm",
    category: "sticker",
    shape: "square",
    medium: "print",
    width: 100,
  ...
  {
    id: "sticker-rect-100x70",
    name: "Rectangular sticker 100 × 70 mm",
    category: "sticker",
    shape: "landscape",
    medium: "print",
    width: 100,
  ...
  {
    id: "a6-landscape",
    name: "A6 landscape counter card",
    category: "counter",
    shape: "landscape",
    medium: "print",
    width: 148,
  ...
  {
    id: "dl-landscape",
    name: "DL landscape counter card",
    category: "counter",
    shape: "landscape",
    medium: "print",
    width: 210,
  ...
  },
  {
    ...
    bleed: 3,
    minQrSize: 45,
    material: "350 gsm silk, scored + folded",
    folded: true,
  },
  {
    id: "tent-a6",
    name: "Folded A6 table tent",
    category: "counter",
    shape: "folded",
    medium: "print",
    width: 105,
  ...
  },
  {
    ...
    bleed: 0,
    minQrSize: 40,
    material: "Insert for acrylic stand",
  },
  {
    id: "acrylic-dl",
    name: "Acrylic stand insert DL",
    category: "counter",
    shape: "portrait",
    medium: "print",
    width: 99,
  ...
  {
    id: "compendium-a6",
    name: "A6 room compendium insert",
    category: "hotel",
    shape: "portrait",
    medium: "print",
    width: 105,
  ...
  {
    id: "mirror-100",
    name: "100 × 100 mm bathroom mirror sticker",
    category: "hotel",
    shape: "square",
    medium: "print",
    width: 100,
...
export const SHAPE_FILTERS: FormatShape[] = [
  "circular",
  "square",
  "portrait",
  "landscape",
...
export const CATEGORY_FILTERS: FormatCategory[] = [
  "sticker",
  "counter",
  "poster",
  "hotel",
